 ...
 *
 */
public enum ResearchFields implements ResearchType {
    ENERGY_TECH("Energietechnik", 0, 400, 200, 2) {
        @Override
        public Requirement getRequirement() {
            return Requirement.of(PlanetBuilding.RESEARCHLAB, 1);
        }
    },
    LASER_TECH("Lasertechnik", 100, 50, 0, 2) {
        @Override
        public Requirement getRequirement() {
            return Requirement.of(PlanetBuilding.RESEARCHLAB, 1, ENERGY_TECH, 2);
        }
    },
    ION_TECH("Ionentechnik", 500, 150, 50, 2) {
        @Override
        public Requirement getRequirement() {
            return Requirement.of(PlanetBuilding.RESEARCHLAB, 4, LASER_TECH, 5, ENERGY_TECH, 4);
        }
    },
    PLASMA_TECH("Plasmatechnik", 1_000, 2_000, 500, 2) {
        @Override
        public Requirement getRequirement() {
            return Requirement.of(PlanetBuilding.RESEARCHLAB, 4, LASER_TECH, 10, ION_TECH, 5, ENERGY_TECH, 8);
        }
    },
    HYPERSPACE_TECH("Hyperraumtechnik", 0, 2_000, 1_000, 2) {
        @Override
        public Requirement getRequirement() {
            return Requirement.of(PlanetBuilding.RESEARCHLAB, 7, ENERGY_TECH, 5, SHIELD_TECH, 5);
        }
    },
    COMBUSTION_ENGINE("Verbrennungstriebwerk", 200, 0, 300, 2) {
        @Override
        public Requirement getRequirement() {
            return Requirement.of(PlanetBuilding.RESEARCHLAB, 1, ENERGY_TECH, 1);
        }
    },
    IMPULSE_ENGINGE("Impulstriebwerk", 1_000, 2_000, 300, 2) {
        @Override
        public Requirement getRequirement() {
            return Requirement.of(PlanetBuilding.RESEARCHLAB, 2, ENERGY_TECH, 1);
        }
    },
    HYPERSPACE_DRIVE("Hyperraumantrieb", 5_000, 10_000, 3_000, 2) {
        @Override
        public Requirement getRequirement() {
            return Requirement.of(PlanetBuilding.RESEARCHLAB, 7, HYPERSPACE_TECH, 3);
        }
    },
    SPIONAGE_TECH("Spionagetechnik", 100, 500, 100, 2) {
        @Override
        public Requirement getRequirement() {
            return Requirement.of(PlanetBuilding.RESEARCHLAB, 3);
        }
    },
    ...
    ASTROPHYSICS("Astrophysik", 0, 0, 0, 0) {
        ...
        @Override
        public Requirement getRequirement() {
            return Requirement.of(PlanetBuilding.RESEARCHLAB, 3, SPIONAGE_TECH, 4, IMPULSE_ENGINGE, 3);
        }
    ...
    INTERGALACTIC_RESEARCHNETWORK("Intergalaktisches Forschungsnetzwerk", 120_000, 200_000, 80_000, 2) {
        @Override
        public Requirement getRequirement() {
            return Requirement.of(PlanetBuilding.RESEARCHLAB, 10, COMPUTER_TECH, 8, HYPERSPACE_TECH, 8);
        }
    },
    GRAVITON_RESEARCH("Gravitonforschung", true, 100_000, 3) {
        @Override
        public Requirement getRequirement() {
            return Requirement.of(PlanetBuilding.RESEARCHLAB, 12);
        }
    },
    WEAPON_TECH("Waffentechnik", 400, 200, 0, 2) {
        @Override
        public Requirement getRequirement() {
            return Requirement.of(PlanetBuilding.RESEARCHLAB, 4);
        }
    },
    SHIELD_TECH("Schildtechnik", 100, 300, 0, 2) {
        @Override
        public Requirement getRequirement() {
            return Requirement.of(PlanetBuilding.RESEARCHLAB, 6, ENERGY_TECH, 3);
        }
    },
    SHIP_PLATING("Raumschiffpanzerung", 500, 0, 0, 2) {
        @Override
        public Requirement getRequirement() {
            return Requirement.of(PlanetBuilding.RESEARCHLAB, 2);
        }
    };
    ...
    ResearchFields(String name, int metFactor, int crysFactor, int deutFactor, double base) {
        this.name = name;
    ...
    ResearchFields(String name, boolean needsEnergy, int energyFactor, int base) {
