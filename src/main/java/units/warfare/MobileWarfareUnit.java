 ...
 *
 */
public abstract class MobileWarfareUnit extends WarfareUnit {
    ...
    MobileWarfareUnit(RapidFire rapidFire, int structurePoints, int shieldStrength, int attackPower, int speed, int load_capacity, int fuel_consumption) {
